...
use Appfinesse\Scribe\Events\FeatureConsumed;
use Appfinesse\Scribe\Events\FeatureTicketCreated;
...
trait HasSubscriptions
{
    ...
    {
        return $this->morphMany(config('scribe.models.feature_consumption'), 'subscriber');
    }

    public function featureTickets()
    {
        return $this->morphMany(config('scribe.models.feature_ticket'), 'subscriber');
    }

    public function renewals()
    {
        return $this->hasManyThrough(
            config('scribe.models.subscription_renewal'),
            config('scribe.models.subscription'),
            'subscriber_id',
        );
    }
    ...
    {
        return $this->morphOne(config('scribe.models.subscription'), 'subscriber')->ofMany('started_at', 'MAX');
    }

    public function lastSubscription()
    {
        return app(config('scribe.models.subscription'))
            ->withExpired()
    ...
    {
        if (! config('scribe.feature_tickets')) {
